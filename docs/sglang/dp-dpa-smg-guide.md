  ...
  <tbody>
    <tr>
      <td style={{padding: "9px 12px", verticalAlign: "top", backgroundColor: "rgba(255,255,255,0.02)"}}>
        <img src="https://mintcdn.com/lmsysorg/lCXzAEQmak7oHiXq/images/dpa.png?fit=max&auto=format&n=lCXzAEQmak7oHiXq&q=85&s=8a553be0ceb61b8d20241372e3b00370" alt="DPA + EP Architecture" style={{width: "100%", height: "auto"}} width="1007" height="1113" data-path="images/dpa.png" />
      </td>
...
<table style={{width: "100%", borderCollapse: "collapse", tableLayout: "fixed"}}>
  ...
  <tbody>
    <tr>
      <td style={{padding: "9px 12px", fontWeight: 500, backgroundColor: "rgba(255,255,255,0.02)"}}><code>cache\_aware</code></td>
    ...
    <tr>
      <td style={{padding: "9px 12px", fontWeight: 500, backgroundColor: "rgba(255,255,255,0.02)"}}><code>round\_robin</code></td>
    ...
    <tr>
      <td style={{padding: "9px 12px", fontWeight: 500, backgroundColor: "rgba(255,255,255,0.02)"}}><code>power\_of\_two</code></td>
