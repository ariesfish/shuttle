...
source: https://docs.nvidia.com/dynamo/kubernetes-deployment/multinode/topology-aware-scheduling
source_markdown: https://docs.nvidia.com/dynamo/kubernetes-deployment/multinode/topology-aware-scheduling.md
---
...
TAS controls pod placement. To constrain or bias the Dynamo router's prefill-to-decode handoff after pods are already running, see [Topology-Aware KV Transfer](/dynamo/kubernetes-deployment/deployment-guide/topology-aware-kv-transfer).
