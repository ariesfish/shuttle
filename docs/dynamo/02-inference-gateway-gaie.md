...
source: https://docs.nvidia.com/dynamo/kubernetes-deployment/deployment-guide/inference-gateway-gaie
source_markdown: https://docs.nvidia.com/dynamo/kubernetes-deployment/deployment-guide/inference-gateway-gaie.md
---
...
[See Quickstart Guide](/dynamo/getting-started/kubernetes-deployment) to install Dynamo Kubernetes Platform.
If you are installing from the source tree rather than a release chart, follow [Path B: Custom Build from Source](/dynamo/kubernetes-deployment/deployment-guide/installation-guide#path-b-custom-build-from-source) and run `helm dep build ./platform/` before `helm install` so the vendored subcharts match the local chart contents.
...
- See the [KV cache routing design](/dynamo/design-docs/component-design/router-design) for details.
