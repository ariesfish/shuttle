...
source: https://docs.nvidia.com/dynamo/kubernetes-deployment/deployment-guide/dynamo-operator
source_markdown: https://docs.nvidia.com/dynamo/kubernetes-deployment/deployment-guide/dynamo-operator.md
---
...
**📖 [Managing Models with DynamoModel Guide](/dynamo/kubernetes-deployment/deployment-guide/managing-models-with-dynamo-model)**
...
**📖 [Webhooks Guide](/dynamo/kubernetes-deployment/deployment-guide/webhooks)**
...
**📖 [Operator Metrics Guide](/dynamo/kubernetes-deployment/observability-k-8-s/operator-metrics)**
...
For detailed installation options, see the [Installation Guide](/dynamo/kubernetes-deployment/deployment-guide/installation-guide)
