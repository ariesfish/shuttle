...
source: https://docs.nvidia.com/dynamo/kubernetes-deployment/deployment-guide/shadow-engine-failover
source_markdown: https://docs.nvidia.com/dynamo/kubernetes-deployment/deployment-guide/shadow-engine-failover.md
---
...
This is separate from [Dynamo Snapshot](/dynamo/kubernetes-deployment/deployment-guide/snapshot). Snapshot captures and
...
- [Snapshot](/dynamo/kubernetes-deployment/deployment-guide/snapshot)
