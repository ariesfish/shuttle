...
source: https://docs.nvidia.com/dynamo/kubernetes-deployment/observability-k-8-s/operator-metrics
source_markdown: https://docs.nvidia.com/dynamo/kubernetes-deployment/observability-k-8-s/operator-metrics.md
---
...
The operator metrics feature requires the same monitoring infrastructure as application metrics. For detailed setup instructions, see the [Kubernetes Metrics Guide](/dynamo/kubernetes-deployment/observability-k-8-s/metrics#prerequisites).
...
For instructions on accessing Prometheus and Grafana, see the [Kubernetes Metrics Guide](/dynamo/kubernetes-deployment/observability-k-8-s/metrics#viewing-the-metrics).
...
- [Kubernetes Metrics Guide](/dynamo/kubernetes-deployment/observability-k-8-s/metrics) - Application metrics for frontends and workers
- [Dynamo Operator Guide](/dynamo/kubernetes-deployment/deployment-guide/dynamo-operator) - Operator architecture and deployment modes
- [Operator Webhooks](/dynamo/kubernetes-deployment/deployment-guide/webhooks) - Webhook validation details