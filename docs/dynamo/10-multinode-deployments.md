...
source: https://docs.nvidia.com/dynamo/kubernetes-deployment/multinode/multinode-deployments
source_markdown: https://docs.nvidia.com/dynamo/kubernetes-deployment/multinode/multinode-deployments.md
---
...
- [Topology Aware Scheduling](/dynamo/kubernetes-deployment/multinode/topology-aware-scheduling) — pack pods within a rack, block, or other topology domain for lower latency
