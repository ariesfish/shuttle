...
**For LMCache metrics and integration**, see the [LMCache Integration Guide](/dynamo/integrations/lm-cache).
...
- [LMCache Integration Guide](/dynamo/integrations/lm-cache#troubleshooting)

**For complete LMCache configuration and metric details**, see:
- [LMCache Integration Guide](/dynamo/integrations/lm-cache) - Setup and configuration
