...
For quick start instructions, see the [SGLang README](/dynamo/backends/sg-lang). This document provides all deployment patterns for running SGLang with Dynamo, including LLMs, multimodal, and diffusion models, and Kubernetes deployment.
...
Two workers behind a [KV-aware router](/dynamo/components/router) that maximizes cache reuse:
...
For details on how SGLang disaggregation works with Dynamo, including the bootstrap mechanism and RDMA transfer flow, see [SGLang Disaggregation](/dynamo/backends/sg-lang/disaggregation).
...
For full details on all diffusion worker types (LLM, image, video), see [Diffusion](/dynamo/user-guides/diffusion/sg-lang-diffusion).

### Kubernetes Deployment

For complete K8s deployment examples, see:

- [SGLang K8s deployment guide](https://github.com/ai-dynamo/dynamo/tree/v1.2.0/examples/backends/sglang/deploy)
- [SGLang aggregated router K8s example](https://github.com/ai-dynamo/dynamo/blob/v1.2.0/examples/backends/sglang/deploy/agg_router.yaml)
...
- **[SGLang README](/dynamo/backends/sg-lang)**: Quick start and feature overview
- **[Reference Guide](/dynamo/backends/sg-lang/reference-guide)**: Architecture, configuration, and operational details
- **[SGLang Multimodal](../../features/multimodal/multimodal-sglang.md)**: Vision model deployment patterns
- **[SGLang HiCache](/dynamo/backends/sg-lang/hi-cache)**: Hierarchical cache integration
