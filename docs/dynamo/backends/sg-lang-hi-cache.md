...
- [KVBM Guide](/dynamo/user-guides/kv-cache-offloading) — Dynamo's own block manager, an alternative to HiCache
- [KV Events for Custom Engines](/dynamo/integrations/kv-events-for-custom-engines) — the event protocol contract for backends other than SGLang