...
- **[NVIDIA Request Extensions (nvext)](/dynamo/additional-resources/nvidia-request-extensions-nvext)**: Full `nvext` field reference including agent hints
- **[Configuration and Tuning](/dynamo/components/router/configuration-and-tuning)**: Router configuration and CLI arguments
- **[SGLang HiCache](/dynamo/backends/sg-lang/hi-cache)**: Enabling hierarchical KV cache