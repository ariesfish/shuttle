...
- **[Tool Calling](/dynamo/user-guides/tool-calling)**: General tool calling guide
- **[Reference Guide](/dynamo/backends/sg-lang/reference-guide)**: Full SGLang backend reference
- **[Agentic Workloads](/dynamo/backends/sg-lang/agentic-workloads)**: Priority scheduling and cache pinning for agents