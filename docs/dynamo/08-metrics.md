---
title: Metrics
source: https://docs.nvidia.com/dynamo/kubernetes-deployment/observability-k-8-s/metrics
source_markdown: https://docs.nvidia.com/dynamo/kubernetes-deployment/observability-k-8-s/metrics.md
---
...
Before setting up metrics collection, you'll need to have the Dynamo operator installed in your cluster. Follow our [Installation Guide](/dynamo/kubernetes-deployment/deployment-guide/installation-guide) for detailed instructions on deploying the Dynamo operator.
...
![Prometheus UI showing Dynamo metrics](https://files.buildwithfern.com/dynamo.docs.buildwithfern.com/dynamo/ce1da1f068dc5b2a4e6b8fb18bd9d9f2dfae55962c18ee13b3c48e43b4737eb2/pages-v1.2.0/assets/img/prometheus-k8s.png)
...
![Grafana dashboard showing Dynamo metrics](https://files.buildwithfern.com/dynamo.docs.buildwithfern.com/dynamo/692d89c259057f1e6494336aa3ba470521a4ff6cc4d738e3cb25fa250e0e59a0/pages-v1.2.0/assets/img/grafana-k8s.png)
...
>
> See the **[Operator Metrics Guide](/dynamo/kubernetes-deployment/observability-k-8-s/operator-metrics)** for details on operator-specific metrics and the operator dashboard.