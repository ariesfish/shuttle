...
> **Learn more:** See the [SGLang HiCache Integration Guide](/dynamo/backends/sg-lang/hi-cache) for detailed configuration, deployment examples, and troubleshooting.
...
![Grafana Example](https://files.buildwithfern.com/dynamo.docs.buildwithfern.com/dynamo/4bac8f06eca58fc45f8cc06b1b553f6c2c74461aae57863badfad18b4d6be572/pages-v1.2.0/assets/img/kvbm-metrics-grafana.png)
...
- [KVBM Overview](/dynamo/components/kvbm) for a quick overview of KV Caching, KVBM and its architecture
- [KVBM Design](/dynamo/design-docs/component-design/kvbm-design) for a deep dive into KVBM architecture
- [LMCache Integration](/dynamo/integrations/lm-cache)
- [FlexKV Integration](/dynamo/integrations/flex-kv)
- [SGLang HiCache](/dynamo/backends/sg-lang/hi-cache)