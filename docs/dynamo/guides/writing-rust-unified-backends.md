...
> [`dynamo-backend-common`](https://github.com/ai-dynamo/dynamo/tree/v1.2.0/lib/backend-common): a shared
...
[`LLMEngine`](https://github.com/ai-dynamo/dynamo/blob/v1.2.0/lib/backend-common/src/engine.rs) contract in
[`dynamo-backend-common`](https://github.com/ai-dynamo/dynamo/tree/v1.2.0/lib/backend-common) — no Python
worker runtime required. For the Python version of the same contract
see [Writing a Python Unified Backend](/dynamo/user-guides/writing-python-unified-backends).
...
[Writing a Python Unified Backend](/dynamo/user-guides/writing-python-unified-backends) — same
contract, lighter setup. The non-unified fallback for feature gaps
(multimodal, LoRA, logprobs, etc.) is Python-only; see
[Writing Python Workers](/dynamo/user-guides/writing-python-workers-lower-level) if you need one of those
today.

The reference example is the **mocker backend** at
[`lib/backend-common/examples/mocker`](https://github.com/ai-dynamo/dynamo/tree/v1.2.0/lib/backend-common/examples/mocker)
...
- [`LLMEngine` trait doc comments](https://github.com/ai-dynamo/dynamo/blob/v1.2.0/lib/backend-common/src/engine.rs)
  — authoritative method-by-method contract.
- [Crate README](https://github.com/ai-dynamo/dynamo/blob/v1.2.0/lib/backend-common/README.md) — in-tree
  reference: architecture, file index, disaggregation contract,
  error taxonomy, conformance kit.
- [`backend-common` design notes](https://github.com/ai-dynamo/dynamo/blob/v1.2.0/lib/backend-common/CLAUDE.md)
...
- Disaggregated serving (`Aggregated` / `Prefill` / `Decode`) — KV
  ...
  [mocker example](https://github.com/ai-dynamo/dynamo/tree/v1.2.0/lib/backend-common/examples/mocker)
