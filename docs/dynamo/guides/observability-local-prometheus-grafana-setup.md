...
![Grafana Dynamo Dashboard](https://files.buildwithfern.com/dynamo.docs.buildwithfern.com/dynamo/0e5d1391b49dd5d3ceed8f2a33bb122c9f2b4155be83f348db93959ab9489efb/pages-v1.2.0/assets/img/grafana-dynamo-composite.png)
...
**For metrics reference**, see [Metrics Documentation](/dynamo/user-guides/observability-local/metrics).
...
Start the observability stack (Prometheus, Grafana, Tempo, exporters). See [Observability Getting Started](/dynamo/user-guides/observability-local#getting-started-quickly) for instructions and prerequisites.
...
**Note:** Labeled series (e.g., `...{model="..."}`) only appear after the first matching request is served. See [Available Metrics](/dynamo/user-guides/observability-local/metrics#available-metrics) for details.
...
- **Tempo** (tracing): Accessible through Grafana's Explore view. See [Tracing Guide](/dynamo/user-guides/observability-local/tracing) for details.
...
After making changes to prometheus.yml, restart the Prometheus service. See [Observability Getting Started](/dynamo/user-guides/observability-local#getting-started-quickly) for Docker Compose commands.
...
For specific Docker Compose commands, see [Observability Getting Started](/dynamo/user-guides/observability-local#getting-started-quickly).

## Developer Guide

For detailed information on creating custom metrics in Dynamo components, see:

- [Metrics Developer Guide](/dynamo/user-guides/observability-local/metrics-developer-guide)