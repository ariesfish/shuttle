...
The metrics API is accessible through the `.metrics()` method on runtime, namespace, component, and endpoint objects. See [Runtime Hierarchy](/dynamo/user-guides/observability-local/metrics#runtime-hierarchy) for details on the hierarchical structure.
...
- [Metrics Overview](/dynamo/user-guides/observability-local/metrics)
