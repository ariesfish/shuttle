...
> [`dynamo.common.backend`](https://github.com/ai-dynamo/dynamo/tree/v1.2.0/components/src/dynamo/common/backend):
...
> [Writing a Rust Unified Backend](/dynamo/user-guides/writing-rust-unified-backends). For the
...
> [Writing Python Workers](/dynamo/user-guides/writing-python-workers-lower-level).
>
...
- [Sample engine](../../components/src/dynamo/common/backend/sample_engine.py)
  — example user guide.
- [Writing a Rust Unified Backend](/dynamo/user-guides/writing-rust-unified-backends) — the Rust
