---
title: Model Caching
source: https://docs.nvidia.com/dynamo/kubernetes-deployment/deployment-guide/model-caching
source_markdown: https://docs.nvidia.com/dynamo/kubernetes-deployment/deployment-guide/model-caching.md
---
...
You need this path for the `pvcModelPath` field in a DGDR spec (see [Model Deployment Guide — Model Caching](/dynamo/kubernetes-deployment/deployment-guide/model-deployment-guide#model-caching)).
...
ModelExpress and ModelStreamer are model loading and distribution paths. They are not required for [Shadow Engine Failover](/dynamo/kubernetes-deployment/deployment-guide/shadow-engine-failover), and enabling them does not create standby engines.
...
- [Managing Models with DynamoModel](/dynamo/kubernetes-deployment/deployment-guide/managing-models-with-dynamo-model) — declarative model management CRD
- [Detailed Installation Guide](/dynamo/kubernetes-deployment/deployment-guide/installation-guide) — Helm chart configuration including ModelExpress
- [Shadow Engine Failover](/dynamo/kubernetes-deployment/deployment-guide/shadow-engine-failover) — GMS-backed active/shadow engine recovery, separate from model distribution
