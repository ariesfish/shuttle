...
source: https://docs.nvidia.com/dynamo/kubernetes-deployment/deployment-guide/topology-aware-kv-transfer
source_markdown: https://docs.nvidia.com/dynamo/kubernetes-deployment/deployment-guide/topology-aware-kv-transfer.md
---
...
For RDMA/NIXL transport setup, see [Disagg Communication](/dynamo/kubernetes-deployment/deployment-guide/disagg-communication).
...
[Topology Aware Scheduling](/dynamo/kubernetes-deployment/multinode/topology-aware-scheduling) controls where Kubernetes places pods. Topology-aware KV transfer controls how Dynamo routes between already-running prefill and decode workers.
