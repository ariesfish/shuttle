---
title: Logging
source: https://docs.nvidia.com/dynamo/kubernetes-deployment/observability-k-8-s/logging
source_markdown: https://docs.nvidia.com/dynamo/kubernetes-deployment/observability-k-8-s/logging.md
---
...
This guide assumes you have installed Dynamo Kubernetes Platform. For more information, see [Dynamo Kubernetes Platform](/dynamo/getting-started/kubernetes-deployment).
