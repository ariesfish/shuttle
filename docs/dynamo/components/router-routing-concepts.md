...
This page explains how the Dynamo router evaluates workers, chooses a target, and fits into the request path. For CLI flags and tuning knobs, see [Configuration and Tuning](/dynamo/components/router/configuration-and-tuning).
...
For the flags that enable these models, see [Configuration and Tuning](/dynamo/components/router/configuration-and-tuning).
...
For detailed CLI arguments and advanced configuration options, see [Configuration and Tuning](/dynamo/components/router/configuration-and-tuning).
...
For benchmarking KV router performance, see the [KV Router A/B Benchmarking Guide](/dynamo/additional-resources/kv-router-a-b-testing).
For custom routing logic and advanced patterns, see [Routing Patterns](/dynamo/components/router/router-examples#routing-patterns).
