...
For deployment examples, see [Kubernetes Topology-Aware KV Transfer](/dynamo/kubernetes-deployment/deployment-guide/topology-aware-kv-transfer).
...
[Verify the Deployment](/dynamo/kubernetes-deployment/deployment-guide/topology-aware-kv-transfer#verify-the-deployment).