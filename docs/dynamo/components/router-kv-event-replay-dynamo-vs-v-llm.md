...
- **[KV Router Index Data Structures](https://github.com/ai-dynamo/dynamo/blob/v1.2.0/lib/kv-router/src/indexer/README.md)**: `RadixTree`, `ConcurrentRadixTree`, and `PositionalIndexer` internals
- **[Router Guide](/dynamo/user-guides/kv-cache-aware-routing)**: Deployment modes and quick start for KV-aware routing
- **[Configuration and Tuning](/dynamo/components/router/configuration-and-tuning)**: Router flags and tuning details
