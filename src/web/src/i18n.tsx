...
const dictionaries: Record<Locale, Dictionary> = {
  zh: {
    ...
    acceleratorPoolsTitle: '加速卡池',
    acceleratorPoolsDescription: '定义 operator-owned Accelerator Pool，并查看 observed inventory summary。',
    createCluster: '创建集群',
    name: '名称',
    description: '描述',
    ...
    revisionCount: 'Revision 数',
    nodeCount: '节点数',
    observedAt: '观测时间',
    probeStatus: '探测状态',
    nodeNames: '节点',
    acceleratorResources: '加速卡资源',
    acceleratorCount: '加速卡数',
    acceleratorModels: '加速卡型号',
    memoryMiB: '显存 MiB',
    nodeSelector: 'Node Selector',
    summary: '摘要',
    warnings: '告警',
    nvidiaAccelerators: 'NVIDIA 加速卡',
    connectivity: '连接能力',
    missing: '缺失',
    capabilities: '能力',
    noData: '暂无数据',
  ...
  en: {
    ...
    navAcceleratorPools: 'Accelerator Pools',
    ...
    acceleratorPoolsTitle: 'Accelerator Pools',
    acceleratorPoolsDescription: 'Define operator-owned Accelerator Pools and inspect observed inventory summaries.',
    ...
    nodeNames: 'Nodes',
    acceleratorResources: 'Accelerator Resources',
    acceleratorCount: 'Accelerator Count',
    acceleratorModels: 'Accelerator Models',
    memoryMiB: 'Memory MiB',
    nodeSelector: 'Node Selector',
    summary: 'Summary',
    warnings: 'Warnings',
    nvidiaAccelerators: 'NVIDIA Accelerators',
    ...
    project: 'Project',
    cluster: 'Cluster',
    acceleratorPool: 'Accelerator Pool',
